...
export function ListQuestions(){
    ...
    return (
        <>
            <div className="list-questions" data-aos="zoom-out-up">
                <div class="questions">
                    <button onClick={() => openQuestion(1)}>
                        Quais serviços você oferece ?
                        <Logos isQuestion/>
                    </button>
                    <button onClick={() => openQuestion(2)}>
                        Qual o valor dos projetos ?
                        <Logos isQuestion/>
                    </button>
                    <button onClick={() => openQuestion(3)}>
                        Como funciona a criação dos projetos ?
                        <Logos isQuestion/>
                    </button>
                    <button onClick={() => openQuestion(4)}>
